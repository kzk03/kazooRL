...
def analyze_current_structure():
    ...
    root_scripts = {
        "パイプライン": [
            "run_full_training_from_scratch.py"
        ],
        "分析・レポート": [
    ...
    scripts_dir = {
        ...
        "IRL関連": [
            "scripts/train_irl.py"
        ],
        "RL関連": [
            "scripts/train_oss.py"
        ],
        "評価": [
            "scripts/evaluate_2022_test.py"
        ],
        "パイプライン": [
...
def create_reorganization_plan():
    ...
    moves = [
        ...
        ("tools/analysis/create_expert_trajectories.py", "data_processing/create_trajectories.py"),
    ]
