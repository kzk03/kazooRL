...
def main():
    ...
    try:
        ...
        # 主要特徴量を表示
        key_features = [
            'task_text_length_log', 'task_priority_label_score', 
            'task_urgency_keyword_count', 'task_technical_term_density',
        ...
        sample_developer = {
            ...
            'touched_files': [
                'src/api/views.py', 'frontend/components/App.js', 
                'tests/test_api.py', 'docs/api.md'
            ],
        ...
        # 主要特徴量を表示
        key_dev_features = [
            'dev_primary_language_strength', 'dev_overall_consistency_score',
            'dev_pr_merge_rate', 'dev_overall_quality_score',
        ...
        key_matching_features = [
            'match_collaboration_strength_enhanced', 'match_skill_compatibility_weighted',
            'match_overall_tech_compatibility', 'match_estimated_success_probability',
        ...
        for designer, features, name in [
            ...
            if invalid_count == 0 and warning_count == 0:
                ...
                print(f"⚠️  {name}特徴量検証: 無効{invalid_count}個, 警告{warning_count}個")
        ...
        total_unique_features = len(set(task_feature_names + dev_feature_names + matching_feature_names))
