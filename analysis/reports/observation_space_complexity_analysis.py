...
def analyze_observation_spaces():
    ...
    print(f"   総次元: {num_tasks * 3 + 64} = {complex_obs_space['simple_obs'].shape[0]} + {complex_obs_space['gnn_embeddings'].shape[0]}")
...
(Tuple/Dict space inside Tuple/Dict space).
    ...
    efficiency = (complex_memory['total'] - simple_memory['total']) / complex_memory['total'] * 100
