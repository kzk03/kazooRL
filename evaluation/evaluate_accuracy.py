...
def load_test_data_with_ground_truth(test_data_path: str) -> Tuple[List[Dict], List[str]]:
...
def load_agent_profiles(model_dir: str, actual_authors: List[str] = None) -> Dict[str, Dict]:
