...
FEATURE_DIM = 5
FEATURE_NAMES = ["Task Completion", "PR Size (Additions)", "Skill Match (dummy)", "Review Cost", "Action Cost"]
...
def get_features(state, action_enum, action_details, actor_id):
    ...
    if action_enum in [Action.APPROVE_PULL_REQUEST, Action.MERGE_PULL_REQUEST, Action.CLOSE_ISSUE]:
        features[0] = 1.0
