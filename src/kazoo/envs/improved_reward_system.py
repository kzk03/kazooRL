...
class ImprovedRewardSystem:
    ...
    def calculate_reward(
        self, agent_id: str, task: Dict, action_type: str, env_state: Dict
    ) -> float:
        """
        多面的な報酬計算
    ...
    def _calculate_skill_match_reward(
        self, agent_id: str, task: Dict, env_state: Dict
    ) -> float:
        """スキル適合度報酬"""
        try:
    ...
    def _calculate_collaboration_reward(
        self, agent_id: str, task: Dict, env_state: Dict
    ) -> float:
        """コラボレーション報酬"""
        try:
