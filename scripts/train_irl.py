...
def main():
    ...
    print(f"4. Starting training loop with {len(expert_trajectory_steps)} expert steps...")
    for epoch in range(cfg.irl.epochs):
        ...
        for step_data in expert_trajectory_steps:
            ...
            event_timestamp = datetime.fromisoformat(action_details.get('timestamp').replace('Z', '+00:00'))
