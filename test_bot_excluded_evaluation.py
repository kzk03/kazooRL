...
def evaluate_bot_filtering_impact():
    ...
    print(f"  Bot in Top-1: {bot_in_top1_count}/{total_tasks} ({bot_in_top1_count/total_tasks:.1%})")
    print(f"  Bot in Top-3: {bot_in_top3_count}/{total_tasks} ({bot_in_top3_count/total_tasks:.1%})")
    print(f"  Bot in Top-5: {bot_in_top5_count}/{total_tasks} ({bot_in_top5_count/total_tasks:.1%})")
...
def analyze_expert_trajectories():
    ...
    try:
        ...
        print(f"Original trajectories loaded: {len(original_trajectories)} trajectories")
    ...
    try:
        ...
        print(f"Bot-excluded trajectories loaded: {len(bot_excluded_trajectories)} trajectories")
